...
const FeaturesSection = () => {
  return <section className="py-24 relative z-10">
      <div className="w-full px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold gradient-text mb-4">Why choose Shortify?</h2>
  ...
  >
              <div className="relative z-20 p-8 text-center group">
                <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-5 group-hover:bg-primary/20 group-hover:scale-110 group-hover:shadow-[0_0_25px_hsl(135_100%_42%/0.25)] group-hover:rotate-[5deg] transition-all duration-500">
                  <feature.icon className="w-6 h-6 text-primary group-hover:scale-110 group-hover:drop-shadow-[0_0_8px_hsl(135_100%_42%/0.6)] transition-all duration-300" />
                </div>
